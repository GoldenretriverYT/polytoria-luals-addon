...
function NetworkEventTypeDef:Connect(callback)
end
...
function NetworkEvent:InvokeServer(netmsg)
end
...
---@param netmsg NetMessage
---@param player Player
function NetworkEvent:InvokeClient(netmsg, player)
end
...
--- Only available on the server.
---@param netmsg NetMessage
function NetworkEvent:InvokeAllClients(netmsg)
end