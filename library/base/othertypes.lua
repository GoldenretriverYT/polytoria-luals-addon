...
---@return NetMessage
function NetMessage:New()
end

---Sets a key as a string.
---@param key string
---@param value string
function NetMessage:AddString(key, value)
end

---Gets the value of a string key.
---@param key string
---@return string
function NetMessage:GetString(key)
end

---Sets a key as an integer.
---@param key string
---@param int integer
function NetMessage:AddInt(key, int)
end

---Gets the value of an integer key.
---@param key string
---@return integer
function NetMessage:GetInt(key)
end

---Sets a key as a number.
---@param key string
---@param number number
function NetMessage:AddNumber(key, number)
end

---Gets the value of a number key.
---@param key string
---@return number
function NetMessage:GetNumber(key)
end

---Sets a key as a boolean.
---@param key string
---@param bool boolean
function NetMessage:AddBool(key, bool)
end

---Gets the value of a boolean key.
---@param key string
---@return boolean
function NetMessage:GetBool(key)
end

---Sets a key as a Vector2.
---@param key string
---@param Vector2 Vector2
function NetMessage:AddVector2(key, Vector2)
end

---Gets the value of a Vector2 key.
---@param key string
---@return Vector2
function NetMessage:GetVector2(key)
end

---Sets a key as a Vector3.
---@param key string
---@param Vector3 Vector3
function NetMessage:AddVector3(key, Vector3)
end

---Gets the value of a Vector3 key.
---@param key string
---@return Vector3
function NetMessage:GetVector3(key)
end

---Sets a key as a Color.
---@param key string
---@param Color Color
function NetMessage:AddColor(key, Color)
end

---Gets the value of a Color key.
---@param key string
---@return Color
function NetMessage:GetColor(key)
end

---Sets a key as an Instance.
---@param key string
---@param Instance Instance
function NetMessage:AddInstance(key, Instance)
end

---Gets the value of an Instance key.
---@param key string
---@return Instance
function NetMessage:GetInstance(key)
end
