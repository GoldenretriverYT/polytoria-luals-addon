...
---@overload fun(n: number): Vector3 Creates a new Vector3 with an X, Y and Z value of n.
---@overload fun(x: number, y: number): Vector3 Creates a new Vector3 with an X and Y value of x and y, and a Z value of 0.
---@overload fun(x: number, y: number, z: number): Vector3 Creates a new Vector3 with an X, Y and Z value of x, y and z.
---@return Vector3
...
---@param a Vector3
---@param b Vector3
function Vector3.Slerp(a, b)
end

---Spherically interpolates between two vectors.
---@param a Vector3
---@param b Vector3
function Vector3.SlerpUnclamped(a, b)
end
