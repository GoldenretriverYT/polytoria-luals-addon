...
--- @param startValue Color The start value of the tween.
--- @param endValue Color The end value of the tween.
--- @param time number The time in seconds the tween should take.
--- @param callPerStep fun(value: Color) A callback that is called every step of the tween with the current value.
...
--- @param destination Vector3 The end value of the tween.
--- @param time number The time in seconds the tween should take.
--- @param type TweenStyle The style of the tween.
--- @param callback fun() A callback that is called when the tween is complete.
...
--- @param startValue Vector3 The start value of the tween.
--- @param endValue Vector3 The end value of the tween.
--- @param time number The time in seconds the tween should take.
--- @param callPerStep fun(value: Vector3) A callback that is called every step of the tween with the current value.
--- @param type TweenStyle The style of the tween.
--- @param callback fun() A callback that is called when the tween is complete.
